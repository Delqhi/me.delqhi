    ...
    <div class="flex flex-col gap-4">
      <div class="flex items-center justify-between border-b border-gh-border pb-4">
        ...
        <div class="flex gap-2">
          <input type="text" [placeholder]="t()('blog.search')" class="bg-gh-bg border border-gh-border rounded-md px-3 py-1.5 text-sm focus:outline-none focus:border-gh-link focus:ring-1 focus:ring-gh-link text-gh-text placeholder-gh-text-secondary transition-all w-64">
        </div>
      </div>
