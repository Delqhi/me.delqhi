...
@Component({
  ...
  template: `
    @if (post()) {
      <article class="flex flex-col gap-8 pb-12 animate-in fade-in duration-500">
        <!-- Header -->
        <div class="border-b border-gh-border pb-8">
          ...
          <h1 class="text-3xl md:text-4xl font-bold text-gh-text mb-6 leading-tight">{{ post()!.title }}</h1>
          <img [src]="post()!.imageUrl" [alt]="post()!.title" class="w-full h-64 md:h-96 object-cover rounded-lg border border-gh-border" referrerpolicy="no-referrer">
        </div>
        ...
        <div class="mt-12 pt-8 border-t border-gh-border flex flex-col gap-12">
          ...
          <div>
            ...
            <div class="flex flex-wrap gap-3">
              ...
              <button class="w-10 h-10 rounded-full border border-gh-border flex items-center justify-center text-gh-text-secondary hover:text-gh-text hover:bg-gh-bg-secondary transition-colors" title="Telegram"><svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.888-.662 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg></button>
              <button class="w-10 h-10 rounded-full border border-gh-border flex items-center justify-center text-gh-text-secondary hover:text-gh-text hover:bg-gh-bg-secondary transition-colors" title="Hacker News"><svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M0 24V0h24v24H0zM6.951 5.896l4.112 7.708v5.064h1.583v-4.972l4.148-7.799h-1.749l-2.457 4.875c-.372.745-.688 1.434-.688 1.434s-.297-.708-.651-1.434L8.831 5.896h-1.88z"/></svg></button>
              <button class="w-10 h-10 rounded-full border border-gh-border flex items-center justify-center text-gh-text-secondary hover:text-gh-text hover:bg-gh-bg-secondary transition-colors" title="Pinterest"><svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 5.079 3.158 9.417 7.618 11.162-.105-.949-.199-2.403.041-3.439.219-.937 1.406-5.957 1.406-5.957s-.359-.72-.359-1.781c0-1.663.967-2.911 2.168-2.911 1.024 0 1.518.769 1.518 1.688 0 1.029-.653 2.567-.992 3.992-.285 1.193.6 2.165 1.775 2.165 2.128 0 3.768-2.245 3.768-5.487 0-2.861-2.063-4.869-5.008-4.869-3.41 0-5.409 2.562-5.409 5.199 0 1.033.394 2.143.889 2.741.099.12.112.225.085.345-.09.375-.293 1.199-.334 1.363-.053.225-.172.271-.401.165-1.495-.69-2.433-2.878-2.433-4.646 0-3.776 2.748-7.252 7.951-7.252 4.168 0 7.392 2.967 7.392 6.923 0 4.135-2.607 7.462-6.233 7.462-1.214 0-2.354-.629-2.758-1.379l-.749 2.848c-.269 1.045-1.004 2.352-1.498 3.146 1.123.345 2.306.535 3.55.535 6.607 0 11.985-5.365 11.985-11.987C23.97 5.367 18.592 0 12.017 0z"/></svg></button>
              <button class="w-10 h-10 rounded-full border border-gh-border flex items-center justify-center text-gh-text-secondary hover:text-gh-text hover:bg-gh-bg-secondary transition-colors" title="Mastodon"><svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M23.268 5.313c-.35-2.228-2.618-3.616-2.618-3.616C17.58 1.11 12.015 1 12.015 1s-5.565.11-8.635.697c0 0-2.268 1.388-2.618 3.616-.275 1.76-.36 4.08-.32 6.47.04 2.39.22 4.75.22 4.75 0 0 .58 3.2 4.34 4.08 1.88.44 3.76.55 5.64.55 1.88 0 3.76-.11 5.64-.55 3.76-.88 4.34-4.08 4.34-4.08.04-2.39.18-4.75.22-4.75.04-2.39-.04-4.71-.315-6.47zM12 16.5c-1.38 0-2.5-1.12-2.5-2.5v-4c0-1.38 1.12-2.5 2.5-2.5s2.5 1.12 2.5 2.5v4c0 1.38-1.12 2.5-2.5 2.5z"/></svg></button>
              <button class="w-10 h-10 rounded-full border border-gh-border flex items-center justify-center text-gh-text-secondary hover:text-gh-text hover:bg-gh-bg-secondary transition-colors" title="Email"><mat-icon class="text-[18px] w-[18px] h-[18px]">mail</mat-icon></button>
            </div>
          </div>
...
export class BlogPostComponent implements OnInit {
  ...
  ngOnInit() {
    this.route.paramMap.subscribe(params => {
      ...
      if (id) {
        this.post.set(this.blogService.getPost(id) || null);
        this.nextPost.set(this.blogService.getNextPost(id) || null);
