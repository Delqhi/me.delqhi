...
export class BlogPostComponent implements OnInit {
  ...
  shareUrl(post: BlogPost): string {
    return encodeURIComponent(`https://me.delqhi.com/blog/${post.id}`);
  }

  shareTitle(post: BlogPost): string {
    return encodeURIComponent(post.title);
  }
}
